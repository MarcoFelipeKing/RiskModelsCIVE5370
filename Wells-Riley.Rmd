...
Row
------------
### Airborne Risk Prediction Over Time Spent in a Room
...
renderPlotly({
  ...
  layout(legend = list(orientation = "h",   # show entries horizontally
                     ...
                     x = 0.5),
         yaxis = list(title = 'Number infected'), 
         # xaxis = list(title = 'Time (hours)')
             xaxis = list(title = 'Time Spent in the Room (hours)',
...
### Number of Additional Infected Occupants
```{r table, echo=FALSE,warning=FALSE}

renderTable( {WR() %>% slice_tail(n=1) %>% rename("No mitigation"="standard","Extra ventilation"="extra_ventilation","Masking"="masked","Both Masking and Extra Ventilation"="masked_and_vent")})
...
### % Reduction due to Additional Ventilation 
...
### % Reduction due to Additional Ventilation and Masking
